...
<body>
    ...
    <script type="text/javascript" src="${contextPath }/assets/plugins/data-tables/jquery.dataTables.js"></script>
<script type="text/javascript" src="${contextPath }/assets/plugins/data-tables/DT_bootstrap.js"></script>
